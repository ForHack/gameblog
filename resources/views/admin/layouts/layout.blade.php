...
<body class="dark-edition">
  <div class="wrapper ">
    <div class="sidebar" data-color="purple" data-background-color="black" data-image="/assets/admin/img/sidebar-4.jpg">
      <!--
  ...
  <div class="fixed-plugin">
    <div class="dropdown show-dropdown">
      ...
      <ul class="dropdown-menu">
        ...
        <li class="active">
          <a class="img-holder switch-trigger" href="javascript:void(0)">
            <img src="/assets/admin/img/sidebar-2.jpg" alt="">
          </a>
        </li>
        <li>
          <a class="img-holder switch-trigger" href="javascript:void(0)">
            <img src="/assets/admin/img/sidebar-3.jpg" alt="">
          </a>
        </li>
        <li>
          <a class="img-holder switch-trigger" href="javascript:void(0)">
            <img src="/assets/admin/img/sidebar-4.jpg" alt="">
          </a>
        </li>
      </ul>
    </div>
